...
def shift_cipher_clicked():
    ...
    shift_cipher_encrypt_button = tk.Button(shift_cipher_window, text="Encrypt", command=shift_encrypt_message, font=("Arial", 14))
    shift_cipher_decrypt_button = tk.Button(shift_cipher_window, text="Decrypt", command=shift_decrypt_message, font=("Arial", 14))
...
def caesar_cipher_clicked():
    ...
    caesar_cipher_window = tk.Tk()
    caesar_cipher_window.title("CipherLock - Caesar Cipher")
    caesar_cipher_window.geometry("600x400")
    
    # making the functions that will be used for the encryption and decryption of text
    def caesar_encrypt_message():
        message = user_message_entry_field.get()
    ...
    user_message_label = tk.Label(caesar_cipher_window, text="Message", font=("Arial",18))
    user_message_entry_field = tk.Entry(caesar_cipher_window, width=50)

    # creating the buttons for the Caesar Cipher Window
    caesar_cipher_back_button = tk.Button(caesar_cipher_window, text="Back", command=caesar_cipher_window.destroy, font=("Arial", 14))
    caesar_cipher_encrypt_button = tk.Button(caesar_cipher_window, text="Encrypt", command=caesar_encrypt_message, font=("Arial", 14))
    caesar_cipher_decrypt_button = tk.Button(caesar_cipher_window, text="Decrypt", command=caesar_decrypt_message, font=("Arial", 14))

    # layout of the buttons, label, and entry field
    caesar_cipher_back_button.place(relx=0, rely=0)
    user_message_label.place(relx=0.4, rely=0.3)
    user_message_entry_field.place(relx=0.229, rely=0.4)
    caesar_cipher_encrypt_button.place(relx=0.4, rely=0.8,anchor= "center")
    caesar_cipher_decrypt_button.place(relx=0.55, rely=0.8, anchor= "center")
...
def base64_cipher_clicked():
    ...
    # making the window for when the caesar cipher button is clicked by the user
    base64_cipher_window = tk.Tk()
    base64_cipher_window.title("CipherLock - Base64 Cipher")
    base64_cipher_window.geometry("600x400")
    ...
    # creating the entry field for the message; note: no key needed since caesar cipher has fixed shift key of 3
    user_message_label = tk.Label(base64_cipher_window, text="Message", font=("Arial",18))
    user_message_entry_field = tk.Entry(base64_cipher_window, width=50)

    # creating the buttons for the Caesar Cipher Window
    base64_cipher_back_button = tk.Button(base64_cipher_window, text="Back", command=base64_cipher_window.destroy, font=("Arial", 14))
    base64_cipher_encrypt_button = tk.Button(base64_cipher_window, text="Encrypt", command=base64_encrypt_message, font=("Arial", 14))
    base64_cipher_decrypt_button = tk.Button(base64_cipher_window, text="Decrypt", command=base64_decrypt_message, font=("Arial", 14))

    # layout of the buttons, label, and entry field
    base64_cipher_back_button.place(relx=0, rely=0)
    user_message_label.place(relx=0.4, rely=0.3)
    user_message_entry_field.place(relx=0.229, rely=0.4)
    base64_cipher_encrypt_button.place(relx=0.4, rely=0.8,anchor= "center")
    base64_cipher_decrypt_button.place(relx=0.55, rely=0.8, anchor= "center")
def main():
